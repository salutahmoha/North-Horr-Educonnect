...
import {
  ...
  EyeIcon,
  Button,
} from "../StyledComponents/UpdatePasswordStyled";
...
function UpdatePassword() {
  ...
  function handleUpdatePassword(e) {
    e.preventDefault();
    if (!prevPassword) {
      return toast("Previous password required", {
        theme: "toast-error",
        duration: 3000,
      });
    }
    ...
    <UpdatePasswordContainer>
      <UpdatePasswordForm>
        ...
        <div className="update-password">
          <UpdatePasswordLabel htmlFor="previous-password">
            Previous Password
          </UpdatePasswordLabel>
          <PasswordField>
            <PasswordInput
            ...
            />
            <EyeIcon onClick={() => setShowPrevPassword(!showPrevPassword)}>
              <FontAwesomeIcon icon={showPrevPassword ? faEyeSlash : faEye} />
            </EyeIcon>
          </PasswordField>

          <UpdatePasswordLabel htmlFor="new-password">
            New Password
          </UpdatePasswordLabel>
          <PasswordField>
            <PasswordInput
          ...
          <UpdatePasswordLabel htmlFor="confirm-password">
            Confirm Password
          </UpdatePasswordLabel>
          <PasswordField>
            <PasswordInput
