...
} from "../StyledComponents/UpdatePersonalInformation";
    ...
    <Container>
      <FormContainer>
        <Form onSubmit={handleUpdatePersonalInformation}>
          ...
          <ProfileLabel htmlFor="email">Email Address</ProfileLabel>
          <Input
            type="email"
            id="email"
            value={emailAddress}
          ...
          <UpdatePersonalInfoButton type="submit" disabled={isLoading}>
